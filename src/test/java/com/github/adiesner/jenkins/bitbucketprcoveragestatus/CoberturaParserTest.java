...
public class CoberturaParserTest {
    ...
    public void extractCoverageFromCoberturaReportAsLineRatePlusBranchRateDivByTwo() throws IOException {
        String filePath = CoberturaParserTest.class.getResource(
            "/com/github/adiesner/jenkins/bitbucketprcoveragestatus/CoberturaParserTest/cobertura.xml").getFile();
    ...
    public void extractCoverageFromCoberturaReportWithSingleQuotes() throws IOException {
        String filePath = CoberturaParserTest.class.getResource(
            "/com/github/adiesner/jenkins/bitbucketprcoveragestatus/CoberturaParserTest/cobertura-with-single-quotes.xml").getFile();
    ...
    public void extractZeroCoverageIfNoZeroLineRateAndBranchRate() throws IOException {
        String filePath = CoberturaParserTest.class.getResource(
            "/com/github/adiesner/jenkins/bitbucketprcoveragestatus/CoberturaParserTest/cobertura-zero-coverage.xml").getFile();
    ...
    public void extractCoverageIfBranchRateIsZeroAndHasOnlyLineRate() throws IOException {
        String filePath = CoberturaParserTest.class.getResource(
            "/com/github/adiesner/jenkins/bitbucketprcoveragestatus/CoberturaParserTest/cobertura-zero-branch-rate.xml").getFile();
    ...
    public void extractCoverageIfLineRateIsZeroAndHasBranchRate() throws IOException {
        String filePath = CoberturaParserTest.class.getResource(
            "/com/github/adiesner/jenkins/bitbucketprcoveragestatus/CoberturaParserTest/cobertura-zero-line-rate.xml").getFile();
    ...
    public void throwExceptionIfNoLineRate() throws IOException {
        String filePath = CoberturaParserTest.class.getResource(
            "/com/github/adiesner/jenkins/bitbucketprcoveragestatus/CoberturaParserTest/cobertura-no-line-rate.xml").getFile();
    ...
    public void throwExceptionIfNoBranchRate() throws IOException {
        String filePath = CoberturaParserTest.class.getResource(
            "/com/github/adiesner/jenkins/bitbucketprcoveragestatus/CoberturaParserTest/cobertura-no-branch-rate.xml").getFile();
        new CoberturaParser().get(filePath);
    }
