...
public class SimpleCovParserTest {
    ...
    public void extractsCoverageFromSimpleCovReport() {
        String filePath = SimpleCovParserTest.class.getResource(
            "/com/github/adiesner/jenkins/bitbucketprcoveragestatus/SimpleCovParserTest/coverage.json").getFile();
    ...
    public void notPresentPercentButValidJson() {
        String filePath = SimpleCovParserTest.class.getResource(
            "/com/github/adiesner/jenkins/bitbucketprcoveragestatus/SimpleCovParserTest/coverage_no_covered_percent.json").getFile();
    ...
    public void inValidJson() {
        String filePath = SimpleCovParserTest.class.getResource(
            "/com/github/adiesner/jenkins/bitbucketprcoveragestatus/SimpleCovParserTest/coverage_invalid.json").getFile();
