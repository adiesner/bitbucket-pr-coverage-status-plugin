...
public class SonarMasterCoverageRepositoryTest {
    ...
    private String getResponseBodyFromFile(String fileName) throws IOException {
        return IOUtils.toString(this.getClass().getResourceAsStream("/com/github/adiesner/jenkins/bitbucketprcoveragestatus/SonarMasterCoverageRepositoryTest/" + fileName), UTF_8);
    }
}