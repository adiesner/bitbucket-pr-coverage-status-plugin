...
public class JacocoParserTest {
    ...
    public void extractCoverageFromJacocoReport() throws IOException {
        String filePath = JacocoParserTest.class.getResource(
            "/com/github/adiesner/jenkins/bitbucketprcoveragestatus/JacocoParserTest/jacoco.xml").getFile();
    ...
    public void extractCoverageFromJacocoReportWhenNoLinesOfCode() throws IOException {
        String filePath = JacocoParserTest.class.getResource(
            "/com/github/adiesner/jenkins/bitbucketprcoveragestatus/JacocoParserTest/jacoco-no-code.xml").getFile();
    ...
    public void throwExceptionWhenExtractCoverageFromJacocoAndNoLineTag() throws IOException {
        String filePath = JacocoParserTest.class.getResource(
            "/com/github/adiesner/jenkins/bitbucketprcoveragestatus/JacocoParserTest/jacoco-no-line-tag.xml").getFile();
    ...
    public void throwExceptionWhenExtractCoverageFromJacocoAndMissedNotNumber() throws IOException {
        String filePath = JacocoParserTest.class.getResource(
            "/com/github/adiesner/jenkins/bitbucketprcoveragestatus/JacocoParserTest/jacoco-missed-not-number.xml").getFile();
    ...
    public void throwExceptionWhenExtractCoverageFromJacocoAndCoveredNotNumber() throws IOException {
        String filePath = JacocoParserTest.class.getResource(
            "/com/github/adiesner/jenkins/bitbucketprcoveragestatus/JacocoParserTest/jacoco-covered-not-number.xml").getFile();
